...
//one
function increaseValue_one() {
  var value = parseInt(document.getElementById('number_one').value, 10);
  value = isNaN(value) ? 0 : value;
  value++;
  document.getElementById('number_one').value = value;
}

function decreaseValue_one(e) {
  var value = parseInt(document.getElementById('number_one').value, 10);
  value = isNaN(value) ? 0 : value;
  value < 1 ? value = 1 : '';
  value--;
...
//two
function increaseValue_two() {
  var value = parseInt(document.getElementById('number_two').value, 10);
  value = isNaN(value) ? 0 : value;
  value++;
  document.getElementById('number_two').value = value;
}

function decreaseValue_two(e) {
  // e.prevenDefault()
  var value = parseInt(document.getElementById('number_two').value, 10);
  value = isNaN(value) ? 0 : value;
  value < 1 ? value = 1 : '';
...
//three
function increaseValue_three() {
  var value = parseInt(document.getElementById('number_three').value, 10);
  value = isNaN(value) ? 0 : value;
  value++;
  document.getElementById('number_three').value = value;
}

function decreaseValue_three(e) {
  // e.prevenDefault()
  var value = parseInt(document.getElementById('number_three').value, 10);
  value = isNaN(value) ? 0 : value;
  value < 1 ? value = 1 : '';
